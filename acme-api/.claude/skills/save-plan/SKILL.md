...
## Phases
- [x] Phase 1: Data model + schema
  - Files: src/models/discount.ts
  - Acceptance: Zod schema validates percentage/fixed types
- [ ] Phase 2: Route handler + validation
  - Files: src/routes/discounts.ts
